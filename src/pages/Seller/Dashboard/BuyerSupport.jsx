    ...
    return (
        <div className="mt-8">
            ...
            <div className="border border-gray-200 rounded-lg divide-y divide-gray-200">
                ...
                )) : <div className="p-4 text-gray-500">{t.noFaqs}</div>}
            </div>
        </div>
    )
}
                        ...
                        {filteredTickets.map((ticket) => (
                            <tr key={ticket._id}>
                                ...
                                <td className="px-6 py-4 text-sm">
                                    <button onClick={() => onViewTicket(ticket)} className="text-blue-600"><FaEye /></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-lg shadow-2xl">
                <div className="p-5 border-b flex justify-between items-center">
                    <h3 className="text-xl font-bold">{t.createSupportTicket}</h3>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <input placeholder={t.subject} className="w-full border p-2 rounded" value={subject} onChange={e => setSubject(e.target.value)} />
