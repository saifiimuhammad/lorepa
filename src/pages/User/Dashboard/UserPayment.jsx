  ...
  return (
    <div className=''>
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">{t.paymentsReceipts}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-5 h-[170px] rounded-xl shadow-md border border-gray-100 flex flex-col">
          <div className="flex items-center justify-between space-x-3 mb-4">
            <div className="p-2 bg-blue-100 rounded-lg"><FaDollarSign className="w-5 h-5 text-blue-600" /></div>
            <span className="text-sm font-semibold text-[#9DA0A6] ml-auto">+5.2% MoM</span>
          </div>
          <span className="text-sm font-medium text-gray-700 mb-4">{t.totalSpent}</span>
        ...
        <div className="bg-white p-5 h-[170px] rounded-xl shadow-md border border-gray-100 flex flex-col">
          <div className="flex items-center justify-between space-x-3 mb-4">
            <div className="p-2 bg-blue-100 rounded-lg"><FaCalendarAlt className="w-5 h-5 text-blue-600" /></div>
            <span className="text-sm font-semibold text-green-600 ml-auto">+5.2% MoM</span>
          </div>
          <span className="text-sm font-medium text-gray-700 mb-4">{t.thisMonth}</span>
          <p className="text-4xl font-extrabold text-gray-900 leading-none">
            ${transactions.filter(tr => new Date(tr.date).getMonth() === new Date().getMonth()).reduce((sum, t) => sum + t.amount, 0).toFixed(2)}
          </p>
        </div>

        <div className="bg-white p-5 h-[170px] rounded-xl shadow-md border border-gray-100 flex flex-col">
          <div className="flex items-center justify-between space-x-3 mb-4">
            <div className="p-2 bg-red-100 rounded-lg"><FaRedo className="w-5 h-5 text-red-600" /></div>
            <span className="text-sm font-semibold text-[#9DA0A6] ml-auto">+5.2% MoM</span>
          </div>
          <span className="text-sm font-medium text-[#EA4335] mb-4">{t.refunds}</span>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200">
        <div className="p-5 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800 mb-1">{t.transactionHistory}</h2>
